...
<div class="relative inline-flex" x-data="{ open: false }">
    ...
    >
        <div class="pt-0.5 pb-2 px-3 mb-1 border-b border-slate-200 dark:border-slate-700">
            ...
            <div class="text-xs text-slate-500 dark:text-slate-400 italic"></div>
        </div>
        <ul>
            <li>
                <a class="font-medium text-sm text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400 flex items-center py-1 px-3" href="{{ route('profile.show') }}" @click="open = false" @focus="open = true" @focusout="open = false">Perfil de Usuario</a>
            </li>
            <li>
