    ...
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        ...
        <section class="container px-4 mx-auto">
            <div class="mt-6 mb-6 md:flex md:items-center md:justify-between">
                ...
                <button wire:click="$set('ciudadCreate.modalC', true)"
                ...
                <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        <th class="flex gap-3 px-6 py-4 font-normal text-gray-900">
                            <div class="text-sm">
                                <div class="font-medium text-gray-700">{{ $ciudad->name }}</div>
                            </div>
                        </th>
                        <td class="px-6 py-4">{{ $ciudad->nit }}</td>
                        <td class="px-6 py-4">
                            <div class="flex justify-end gap-4">
                                <button wire:click="destroy({{ $ciudad->id }})">
        ...
        <form wire:submit="save">
            <x-dialog-modal wire:model="ciudadCreate.modalC">
                <x-slot name="title">
                    Nueva Ciudad
                </x-slot>
                        ...
                        <div class="px-6 border-b border-gray-900/10 pb-4">
                            ...
                            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                <div class="sm:col-span-full">
                                    ...
                                    <x-input class="w-full" wire:model="ciudadCreate.name" />
                                    <x-input-error for="ciudadCreate.name" />
                                </div>
                ...
                <x-slot name="footer">
                    <div class="px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                        ...
                        <x-danger-button class="mr-2" wire:click="$set('ciudadCreate.modalC', false)">
                            Cancelar
                        </x-danger-button>
                    </div>
                </x-slot>
        ...
        <form wire:submit="update()">
            <x-dialog-modal wire:model="ciudadEdit.modalE">
                <x-slot name="title">
                    Editar Ciudad
                </x-slot>
                        ...
                        <div class="px-6 border-b border-gray-900/10 pb-4">
                            ...
                            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                <div class="sm:col-span-full">
                                    ...
                                    <x-input class="w-full" wire:model="ciudadEdit.name" />
                                    <x-input-error for="ciudadEdit.name" />
                                </div>
                ...
                <x-slot name="footer">
                    <div class="px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                        ...
                        <x-danger-button class="mr-2" wire:click="$set('ciudadEdit.modalE', false)">
                            Cancelar
                        </x-danger-button>
                    </div>
                </x-slot>
